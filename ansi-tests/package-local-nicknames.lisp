...
(import '(ccl:package-local-nicknames
          ccl:package-locally-nicknamed-by-list
          ccl:add-package-local-nickname
          ccl:remove-package-local-nickname)
        (find-package :cl-test))

;;; https://github.com/phoe/trivial-package-local-nicknames/blob/master/trivial-package-local-nicknames.lisp
;;; License https://github.com/phoe/trivial-package-local-nicknames/blob/master/LICENSE
#|
